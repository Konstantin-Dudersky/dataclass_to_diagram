...
diagram = sm.Diagram(
    ...
    transitions=[
        ...
        sm.Transition(state2, state3, "Resume", option="history"),
        sm.Transition(state2, state3, "DeepResume", option="deep_history"),
        sm.Transition(state3, state2, "Pause"),
        sm.Transition(state3, state3, "Failed"),
